...
namespace MyNamespace
{
    ...
    public class MyRecordBuilder
    {
        ...
        {
            return new MyNamespace.MyRecord(_property1, _property2, _property3.Build(), _property4.Select(x => x.Build()));
        }
        ...
        {
            _property3 = new MyCustomTypeBuilder(property3);
            return this;
        }
        ...
        public MyRecordBuilder AddProperty4(params System.Collections.Generic.IReadOnlyCollection<MyCustomType>[] property4)
        {
            if (property4 != null)
            {
                foreach(var itemToAdd in property4)
                {
                    _property4.Add(new MyCustomTypeBuilder(itemToAdd));
                }
            }
            return this;
        }
        ...
        public MyRecordBuilder(string property1, System.Collections.Generic.IEnumerable<string> property2, MyCustomType property3, System.Collections.Generic.IEnumerable<MyCustomType> property4)
        {
            ...
            _property4 = new System.Collections.Generic.List<MyCustomTypeBuilder>();
            _property1 = property1;
            if (property2 != null) foreach (var x in property2) _property2.Add(x);
            _property3 = property3;
            if (property4 != null) foreach (var x in property4) _property4.Add(x);
        }
...
");
        ...
        public void GeneratesRecordUsingReflection()
        {
            ...
            // Act
            var actual = input.ToClass(new ClassSettings()).Build();
            var sut = new CSharpClassGenerator();
      ...
      <SkipWhenFileExists>false</SkipWhenFileExists>
        ...
        public void GeneratesImmutableClassWithInjectedTemplates_Model_With_Method()
        {
            ...
            var model = new[]
            {
                ...
                ).ToImmutableClass(new ImmutableClassSettings(createWithMethod: true)).Build()
            };
            var sut = new CSharpClassGenerator();
...
");
        ...
        public void GeneratesImmutableClassWithInjectedTemplates_Model_No_With_Method()
        {
            ...
            var model = new[]
            {
                ...
                (
                    ...
                    "MyNamespace",
                    properties: properties
                ).ToImmutableClass(new ImmutableClassSettings(createWithMethod: false)).Build()
            };
            var sut = new CSharpClassGenerator();
        ...
        public void GeneratesImmutableClassWithInjectedTemplates_Model_With_Method_Using_ExtensionMethod()
        {
            ...
            var model = new[]
            {
                cls.ToImmutableClass(new ImmutableClassSettings(createWithMethod: false)).Build(),
...
namespace MyNamespace
{
    ...
    public class MyRecordBuilder
    {
        public MyNamespace.MyRecord Build()
        {
            return new MyNamespace.MyRecord(_static);
        }
...
namespace ModelFramework.Generators.Objects.Tests
{
    public class PersonBuilder
    {
        ...
        {
            return new ModelFramework.Generators.Objects.Tests.Person { FirstName = _firstName, LastName = _lastName };
        }
