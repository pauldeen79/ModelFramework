...
namespace ModelFramework.Objects.Extensions
{
    public static class ClassExtensions
    {
        ...
        ) => ((ITypeBase)instance).ToImmutableBuilderClass(newCollectionTypeName, addProperties, addCopyConstructor, newNamespace, instance.IsPoco(), formatInstanceTypeNameDelegate);
