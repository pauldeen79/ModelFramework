...
public class TypeBaseExtensionsTests : TestBase
{
    public class IsMemberValidForImmutableBuilderClass : TypeBaseExtensionsTests
    {
        ...
        public void Throws_On_Null_ParentTypeContainer()
        {
            ...
            // Act & Assert
            sut.Invoking(x => x.IsMemberValidForImmutableBuilderClass(parentTypeContainer: null!, new Pipelines.Builder.PipelineBuilderSettings()))
    ...
    public class GetCustomValueForInheritedClass
    {
        ...
        public void Throws_When_CustomValue_Is_Null()
        {
            ...
            // Act & Assert
            sut.Invoking(x => x.GetCustomValueForInheritedClass(new Pipelines.Builder.PipelineBuilderSettings(), customValue: null!))
    ...
    public class GetImmutableBuilderClassFields : TypeBaseExtensionsTests
    {
        ...
        public void Throws_On_Null_FormattableStringParser()
        {
            ...
            var context = new PipelineContext<ClassBuilder, BuilderContext>(model, new BuilderContext(sut, new Pipelines.Builder.PipelineBuilderSettings(), CultureInfo.InvariantCulture));
