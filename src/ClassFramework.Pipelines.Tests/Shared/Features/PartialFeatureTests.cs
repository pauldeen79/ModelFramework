...
public class PartialFeatureTests : TestBase<PartialFeature>
{
    public class Process : PartialFeatureTests
    {
        ...
        public void Sets_Partial_Property_On_Model_To_True()
        {
            ...
            var context = new PipelineContext<IConcreteTypeBuilder, BuilderContext>(model, new BuilderContext(sourceModel, new Pipelines.Builder.PipelineSettings(), CultureInfo.InvariantCulture));
