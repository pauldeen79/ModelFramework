...
{
    public class PrimaryKeyConstraintField : IPrimaryKeyConstraintField
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrimaryKeyConstraintField" /> class.
        /// </summary>
        /// <param name="name">The name.</param>
        /// <param name="isDescending">if set to <c>true</c> [is descending].</param>
        /// <param name="metadata">The metadata.</param>
        /// <exception cref="ArgumentOutOfRangeException">name;Name cannot be null or whitespace</exception>
        public PrimaryKeyConstraintField(string name, bool isDescending = false, IEnumerable<IMetadata> metadata = null)
        {
