...
namespace ModelFramework.Database.Default
{
    public class UniqueConstraint : IUniqueConstraint
    {
        ...
        public UniqueConstraint(string name, string fileGroupName = null, IEnumerable<IUniqueConstraintField> fields = null, IEnumerable<IMetadata> metadata = null)
        {
            ...
            Fields = new List<IUniqueConstraintField>(fields);
        ...
        /// The fields.
        /// </value>
        public IReadOnlyCollection<IUniqueConstraintField> Fields { get; }
    }
}
