...
public class ClassPropertyBuilderTests
{
    ...
    {
        // Arrange
        var sut = new ClassPropertyBuilder().WithName("Name").WithType(typeof(int));
    ...
    {
        // Arrange
        var sut = new ClassPropertyBuilder().WithName("Name").WithType(typeof(int)).WithParentTypeFullName("MyParent");
