...
namespace ModelFramework.Database.Tests.Builders
{
    ...
    public class DefaultValueConstraintBuilderTests
    {
        [Fact]
        public void Can_Build_Entity_With_All_Bells_And_Whistles()
        {
            // Arrange
            var sut = new DefaultValueConstraintBuilder()
                .WithName("Name")
        ...
        public void Can_Clear()
        {
            ...
            actual.FieldName.Should().BeEmpty();
            actual.DefaultValue.Should().BeEmpty();
        ...
        public void Can_Clear_Metadata()
        {
            ...
            actual.DefaultValue.Should().Be("DefaultValue");
            actual.Metadata.Should().BeEmpty();
        }
        ...
        {
            // Arrange
            var instance = new DefaultValueConstraintBuilder()
                .WithName("Test")
                .WithFieldName("FieldName")
                .WithDefaultValue("DefaultValue")
                .AddMetadata(new MetadataBuilder().WithName("MName").WithValue("MValue"))
            ...
            // Act
            var actual = new DefaultValueConstraintBuilder(instance);

            // Assert
            actual.Name.Should().Be(instance.Name);
            actual.FieldName.Should().Be(instance.FieldName);
            actual.DefaultValue.Should().Be(instance.DefaultValue);
            actual.Metadata.Should().ContainSingle();
