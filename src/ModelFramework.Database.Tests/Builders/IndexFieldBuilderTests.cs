...
namespace ModelFramework.Database.Tests.Builders
{
    ...
    public class IndexFieldBuilderTests
    {
        [Fact]
        public void Can_Clear()
        {
            // Arrange
            var sut = new IndexFieldBuilder()
                .WithName("Name")
                .WithIsDescending()
        ...
        {
            // Arrange
            var sut = new IndexFieldBuilder().WithName("Name");
        ...
        {
            // Arrange
            var instance = new IndexFieldBuilder()
                .WithName("Name")
                .WithIsDescending()
                .AddMetadata(new MetadataBuilder().WithName("MName").WithValue("MValue"))
                .Build();
            ...
            // Act
            var actual = new IndexFieldBuilder(instance);
