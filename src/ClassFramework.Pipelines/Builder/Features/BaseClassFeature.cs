...
public interface IBaseClassFeatureBuilder : IBuilder<IPipelineFeature<ClassBuilder, PipelineBuilderContext>>
{
}

public class BaseClassFeatureBuilder : IBaseClassFeatureBuilder
{
