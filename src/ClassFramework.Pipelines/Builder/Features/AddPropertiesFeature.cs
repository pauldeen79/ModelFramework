...
public class AddPropertiesFeature : IPipelineFeature<ClassBuilder, BuilderContext>
{
    ...
    public void Process(PipelineContext<ClassBuilder, BuilderContext> context)
    {
        ...
        context.Model.AddProperties(
            ...
            .Where
            (
                x => !context.Context.IsAbstractBuilder && context.Context.SourceModel.IsMemberValidForImmutableBuilderClass(x, context.Context.Settings.InheritanceSettings, isForWithStatement: false)
            )
