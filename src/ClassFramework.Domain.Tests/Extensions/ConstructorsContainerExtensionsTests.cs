...
public class ConstructorsContainerExtensionsTests : TestBase
{
    public class HasPublicParameterlessConstructor : ConstructorsContainerExtensionsTests
    {
        ...
        public void Returns_True_When_No_Constructors_Are_Defined()
        {
            ...
            sut.Constructors.Returns(new List<ClassConstructor>());
        ...
        public void Returns_True_When_A_Public_Constructor_Is_Defined_Without_Any_Parameters()
        {
            // Arrange
            var sut = Fixture.Freeze<IConstructorsContainer>();
            sut.Constructors.Returns(new[] { new ClassConstructor(default, Enumerable.Empty<Metadata>(), default, default, default, default, default, Domains.Visibility.Public, Enumerable.Empty<Attribute>(), Enumerable.Empty<CodeStatementBase>(), Enumerable.Empty<Parameter>()) });
        ...
        public void Returns_False_When_A_Private_Constructor_Is_Defined_Without_Any_Parameters()
        {
            // Arrange
            var sut = Fixture.Freeze<IConstructorsContainer>();
            sut.Constructors.Returns(new[] { new ClassConstructor(default, Enumerable.Empty<Metadata>(), default, default, default, default, default, Domains.Visibility.Private, Enumerable.Empty<Attribute>(), Enumerable.Empty<CodeStatementBase>(), Enumerable.Empty<Parameter>()) });
